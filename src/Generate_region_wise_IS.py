...
from correlation_analysis import get_regions_meta
...
datapath = r'D:\documents\AcademicDocuments\MasterCandidate\research\文献\可解释脑龄预测工作汇总\数据\Test\hcp_test/*.nii'
# labelpath = '/n02dat01/users/cchen/HCP/hcp_test/hcp_test.csv'
labelpath = r'C:\Users\h4619\Desktop\可解释脑龄预测工作汇总\程序\simple_brain_age_73\label\hcp_test.csv'
...
region_meta, region_index = get_regions_meta()
...
try:
    ...
    current_model_path = '../Epoch_253_training_state.pkl'
...
for i in range(1, 25):
    ...
    id_list = region_meta[region_meta['region'] == region_name]['id'].tolist()
    print(id_list)
    exit()
    print("Processing No.{} brain area......".format(i))
    mask = mf.make_multi_mask(atlas, id_list)
    ...
    print(f'IS of region {i} computed')
