...
# datapath = r'D:\documents\AcademicDocuments\MasterCandidate\research\文献\可解释脑龄预测工作汇总\程序\simple_brain_age_73\HCP\hcp_test\*.nii'
# labelpath = r'D:\documents\AcademicDocuments\MasterCandidate\research\文献\可解释脑龄预测工作汇总\程序\simple_brain_age_73\HCP\hcp_test\hcp_test.csv'

datapath = r'D:\documents\AcademicDocuments\MasterCandidate\research\文献\可解释脑龄预测工作汇总\数据\多中心数据集\dataset\Test\*.nii'
labelpath = r'D:\documents\AcademicDocuments\MasterCandidate\research\文献\可解释脑龄预测工作汇总\数据\多中心数据集\dataset\Test\Test.csv'
...
try:
    ...
    if prior_model_path:
        ...
        current_model_path = r'C:\Users\h4619\Desktop\simple_ckpts2\Epoch_217_training_state.pkl'
